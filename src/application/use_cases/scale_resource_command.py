...
class ScaleResourceCommand(Command):
    def __init__(self, k8s_service: K8sServiceInterface):
        self.k8s_service = k8s_service

    def execute(self, resource_type: str, name: str, replicas: int, namespace: str = "default") -> Any:
        return self.k8s_service.scale_resource(
